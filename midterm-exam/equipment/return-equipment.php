...
<body>
    <form action="" method="post">
        ...
        <br>
        <input type="text" name="renter_name" id="renter_name" value="<?= $renter_name ?>" disabled>
        <br>
        ...
        <br>
        <select name="equipment_id" id="equipment_id" disabled>
            <option value="">--Select--</option>
            <?php
                $equipmentsList = $rentalObj->fetchAllEquipments();
